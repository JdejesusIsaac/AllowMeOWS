...
describe("StateManager", () => {
  ...
  describe("FamilyConfig", () => {
    ...
    it("saves and loads family config", async () => {
      ...
      // `policyVersion: 0` for pre-3.0.6 configs. Sprint 4.0.3 — same
      // pattern fills `autoSettleWeekly: false` (D4: opt-in by default).
      // The save→load round-trip is still identity-preserving on every
